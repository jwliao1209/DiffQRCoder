...
import srl from "../assets/srl.gif";
import diffqrcoder from "../assets/diffqrcoder.gif";
...
<Header
  ...
  links={[
    ...
    {
      name: "Code",
      url: "https://github.com/jwliao1209/DiffQRCoder",
      icon: "mdi:github",
    },
  ]}
  />

<YouTubeVideo videoId="rIuBahFrBdI?si=hjCqLr5wIxl8mz84"/>
...
<Figure caption="<b>Figure.</b> An overview of our two-stage pipeline with Scanning Robust Perceptual Guidance (SRPG). ">
    <Image source={diffqrcoder} width="1000" altText="two stage generation pipeline"/>
</Figure>
